...
const generateNonCombatEncounter = (
  ...
  return `FIRST: ${getResultFromGeneratorWithRerolls(generateCheckDifficulty, rerollsForDifficulty)} to pass, bonus for ${generateRandomColor()} checks\nTHEN: ${getResultFromGeneratorWithRerolls(generateCheckDifficulty, rerollsForDifficulty)} to pass, bonus for ${generateRandomColor()} checks\nFINALLY: ${getResultFromGeneratorWithRerolls(generateCheckDifficulty, rerollsForDifficulty)} to pass, bonus for ${generateRandomColor()} checks`;
};
